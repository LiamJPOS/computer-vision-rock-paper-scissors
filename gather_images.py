...
IMG_SAVE_PATH = 'C:\\Users\\liamo\\Code\\computer-vision-rock-paper-scissors\\image_data'
...
while True:
    ...
    frame = frame = cv2.resize(frame, (640, 480), interpolation=cv2.INTER_AREA)
    
    cv2.rectangle(frame, (10, 240), (214, 470), (255,255,255), thickness=2)

    if start:
        roi = frame[244:466, 14:204]
